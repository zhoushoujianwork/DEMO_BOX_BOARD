...
{
    lv_color_t color = (v % 2 == 0) ? lv_color_hex(0xEF1616) : lv_color_hex(0x05915D);
...
void _bg_danger_anim_stop(void *obj)
{
    ...
    Serial.println("bg_danger_anim_stop");
}
...
void static_screen(void)
{
    ...
    // lv_style_set_bg_grad_color(&speed_arc_style, lv_color_white()); // 设置背景颜色
    ...
    lv_arc_set_range(ui_speed_arc, 0, 299);
